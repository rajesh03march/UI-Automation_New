...
public class Product extends BaseTest {
	...
	public void FeaturedProductPoleRestoration() throws InterruptedException {
		...
		Page.driver.navigate().back();
		/*
		 * pp.clickProductCartLink(); Thread.sleep(1000);
		 * System.out.println("third is clicked"); pp.ProductPoleRestoration_2();
		 * Assert.assertEquals(Page.getText("FeaturedProductsCellNumber_XPATH"),
		 * "(770) 632-6700 Option 3"); Page.driver.navigate().back();
		 * Thread.sleep(1000); pp.clickProductCartLink(); Thread.sleep(1000);
		 * System.out.println("fourth is clicked"); Thread.sleep(1000);
		 * pp.ProductPoleRestoration_3();
		 * Assert.assertEquals(Page.getText("FeaturedProductsCellNumber_XPATH"),
		 * "(770) 632-6700 Option 3"); Page.driver.navigate().back();
		 * Thread.sleep(1000); pp.clickProductCartLink();
		 */
	}
	...
	public void verifyTheSearchfirstname(Hashtable<String, String> data) throws InterruptedException {
		...
		// Assert.assertEquals(Page.getText("SearcchResultPoleproductThree_XPATH"),
		// "Dummy3 - C-Truss");
		// Assert.assertEquals(Page.getText("SearcchResultPoleproductFour_XPATH"),
		// "Dummy4 - Osmo-C2-Truss®");
	...
	public void verifyTheSearchOneAlphabet(Hashtable<String, String> data) throws InterruptedException {
		...
		// Assert.assertEquals(Page.getText("SearcchResultSingleAlphabet_XPATH"),
		// "Dummy2 - MITC-FUME®");
